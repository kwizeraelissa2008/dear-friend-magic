...
const tour = [
  {
    ...
    desc: "Browse classes and individual student profiles once approved.",
  },
  {
    icon: Shield,
    title: "Incidents & Discipline",
    desc: "Report and review discipline incidents with full audit trail.",
  },
  {
    icon: FileCheck,
    title: "Permissions",
    desc: "Late entry, leave, and other student permissions tracked with expiry.",
  },
  {
    icon: BarChart3,
    title: "Analytics",
    desc: "Trends across classes, gender, and severity — for leadership only.",
  },
  {
    icon: MessageSquare,
    title: "Real-time Chat",
    desc: "Direct and group conversations among approved staff.",
  },
  {
    icon: Calendar,
    title: "Events",
    desc: "School-wide events scheduled by the Principal.",
  },
  {
    icon: Bot,
    title: "AI Assistant",
    desc: "A role-aware agent that takes actions for you — appears after approval.",
  },
];
...
const Pending = () => {
  ...
  // Auto-check on mount
  useEffect(() => {
    if (user) refresh(); /* eslint-disable-line */
  }, [user]);
      ...
      <main className="container mx-auto px-4 py-8 sm:py-12 max-w-4xl">
        ...
        <section className="mt-10">
          <h2 className="text-lg sm:text-xl font-bold mb-1">
            While you wait — what's inside SDMS
          </h2>
          <p className="text-sm text-muted-foreground mb-5">
            A quick tour of what you'll unlock once approved.
          </p>
          ...
          <div className="space-y-3">
            <Card>
              <CardContent className="p-4">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Typically the same day. The Principal is notified the moment
                  you sign up.
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-4">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Yes — and you can also sign in again anytime to check, or just
                  refresh this page.
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-4">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  The Principal assigns the appropriate role on approval. Reach
                  out if it needs changing.
                </p>
              </CardContent>
            </Card>
          </div>
