    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          <Link
            to={student.class_id ? `/sis/class/${student.class_id}` : "/sis"}
          >
              ...
              <div className="flex-1 space-y-3 text-center md:text-left">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <strong>{className || "Unassigned"}</strong>
                  </div>
                  <div>
                    <span className="text-muted-foreground">Gender:</span>{" "}
                    <strong className="capitalize">{student.gender}</strong>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <Badge
                      variant={
                        student.total_marks >= 80
                          ? "default"
                          : student.total_marks >= 60
                            ? "secondary"
                            : "destructive"
                      }
                    >
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setPermForm((p) => ({ ...p, title: e.target.value }))
                        }
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Reported incidents for this student
            </CardDescription>
          </CardHeader>
          <CardContent>
            {incidents.length === 0 ? (
                  ...
                  <div key={inc.id} className="p-3 rounded-lg border space-y-1">
                    ...
                    {inc.marks_deducted ? (
                      <p className="text-xs text-destructive font-medium">
                        -{inc.marks_deducted} marks ({inc.deduction_reason})
                      </p>
                    ) : null}
                  </div>
                ))}
